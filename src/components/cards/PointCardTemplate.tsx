...
const SvgCardTemplate = ({ value, pattern, ...props }: Props) => (
  <svg
  ...
  >
    <defs>
      <style>
        {
          ".CardTemplate_svg__cls-2{font-size:31.6px;fill:#ffea5c;font-family:MyriadPro-Regular,Myriad Pro}.CardTemplate_svg__cls-3,.CardTemplate_svg__cls-5{fill:red}.CardTemplate_svg__cls-3{fill-rule:evenodd}.CardTemplate_svg__cls-4{fill:#e6e6e6}"
        }
      </style>
    </defs>
    <g id="CardTemplate_svg__Layer_2" data-name="Layer 2">
      <g id="CardTemplate_svg__new_cards" data-name="new cards">
        <g
          id="CardTemplate_svg__NEW_card_template"
          data-name="NEW card template"
        >
          <rect
            width={158.74}
            height={246.61}
          ...
          />
          <text
            className="CardTemplate_svg__cls-2"
          ...
          <path
            ...
            className="CardTemplate_svg__cls-3"
          />
          <image
          ...
          />
          <g id="CardTemplate_svg__pattern_base" data-name="pattern base">
            <g id="CardTemplate_svg__innerLayerLeft">
              {pattern[0][0] === 0 ? (
                <circle
                  cx={45.89}
                  cy={73.09}
                  r={7.81}
                  className="CardTemplate_svg__cls-4"
                />
              ) : (
                <path
                  ...
                  className="CardTemplate_svg__cls-5"
                />
              )}
            </g>
            <g id="CardTemplate_svg__innerLayerMid">
              {pattern[0][1] === 0 ? (
                <circle
                  cx={79.37}
                  cy={73.09}
            ...
            <g id="CardTemplate_svg__innerLayerRIght">
              {pattern[0][2] === 0 ? (
                <circle
                  cx={112.85}
                  cy={73.09}
            ...
            <g id="CardTemplate_svg__thirdLayerLeft">
              {pattern[1][0] === 0 ? (
                <circle
                  cx={45.89}
                  cy={106.57}
            ...
            <g id="CardTemplate_svg__thirdLayerMid">
              {pattern[1][1] === 0 ? (
                <circle
                  cx={79.37}
                  cy={106.57}
            ...
            <g id="CardTemplate_svg__thirdLayerRight">
              {pattern[1][2] === 0 ? (
                <circle
                  cx={112.85}
                  cy={106.57}
            ...
            <g id="CardTemplate_svg__secondLayerLeft">
              {pattern[2][0] === 0 ? (
                <circle
                  cx={45.89}
                  cy={140.05}
            ...
            <g id="CardTemplate_svg__secondLayeMid">
              {pattern[2][1] === 0 ? (
                <circle
                  cx={79.37}
                  cy={140.05}
            ...
            <g id="CardTemplate_svg__secondLayerRight">
              {pattern[2][2] === 0 ? (
                <circle
                  cx={112.85}
                  cy={140.05}
            ...
            <g id="CardTemplate_svg__outerLayerLeft">
              {pattern[3][0] === 0 ? (
                <circle
                  cx={45.89}
                  cy={173.53}
            ...
            <g id="CardTemplate_svg__outerLayerMid">
              {pattern[3][1] === 0 ? (
                <circle
                  cx={79.37}
                  cy={173.53}
            ...
            <g id="CardTemplate_svg__outerLayerRight">
              {pattern[3][2] === 0 ? (
                <circle
                  cx={112.85}
                  cy={173.53}
...
export default SvgCardTemplate;
