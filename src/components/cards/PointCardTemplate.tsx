...
const PointCardTemplate = ({ value, pattern, ...props }: Props) => (
  ...
  >
    <defs>
      <style>
        {
          ".template_svg__cls-2{font-size:31.6px;fill:#ffea5c;font-family:MyriadPro-Regular,Myriad Pro}.template_svg__cls-3,.template_svg__cls-6{fill:red}.template_svg__cls-3{fill-rule:evenodd}.template_svg__cls-4{fill:#0f0}.template_svg__cls-5{fill:#e6e6e6}"
        }
      </style>
    </defs>
