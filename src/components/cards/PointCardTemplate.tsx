...
//5 diferentes: pentagono verde
//5 iguais: estrela vermelha
...
const PointCardTemplate = ({ value, pattern, ...props }: Props) => {
  return (
    ...
    >
      <defs>
        <style>
          {`.text-color{fill:#ffea5c}.caret{fill:white}.same{fill:red}.caret{fill-rule:evenodd}
            .random{fill:#0f0}.empty{fill:#e6e6e6}`}
        </style>
      </defs>
      <g id="template_svg__Layer_2" data-name="Layer 2">
        <g id="template_svg__new_cards" data-name="new cards">
          <g id="template_svg__NEW_card_template" data-name="NEW card template">
            ...
            />
            <text
              className="text-color text-2xl font-bold"
            ...
            <g id="template_svg__pattern_base" data-name="pattern base">
              <g id="template_svg__innerLayerLeft">
                ...
                {pattern[0][0] === 0 && (
                  <circle cx={45.89} cy={73.09} r={7.81} className="empty" />
                )}
                {pattern[0][0] === 1 && (
                  <path
              ...
              <g id="template_svg__innerLayerMid">
                ...
                {pattern[0][1] === 0 && (
                  <circle cx={79.37} cy={73.09} r={7.81} className="empty" />
                )}
                {pattern[0][1] === 1 && (
                  <path
              ...
              <g id="template_svg__innerLayerRIght">
                ...
                {pattern[0][2] === 0 && (
                  <circle cx={112.85} cy={73.09} r={7.81} className="empty" />
                )}
                {pattern[0][2] === 1 && (
                  <path
              ...
              <g id="template_svg__thirdLayerLeft">
                ...
                {pattern[1][0] === 0 && (
                  <circle cx={45.89} cy={106.57} r={7.81} className="empty" />
                )}
                {pattern[1][0] === 1 && (
                  <path
              ...
              <g id="template_svg__thirdLayerMid">
                ...
                {pattern[1][1] === 0 && (
                  <circle cx={79.37} cy={106.57} r={7.81} className="empty" />
                )}
                {pattern[1][1] === 1 && (
                  <path
              ...
              <g id="template_svg__thirdLayerRight">
                ...
                {pattern[1][2] === 0 && (
                  <circle cx={112.85} cy={106.57} r={7.81} className="empty" />
                )}
                {pattern[1][2] === 1 && (
                  <path
              ...
              <g id="template_svg__secondLayerLeft">
                ...
                {pattern[2][0] === 0 && (
                  <circle cx={45.89} cy={140.05} r={7.81} className="empty" />
                )}
                {pattern[2][0] === 1 && (
                  <path
              ...
              <g id="template_svg__secondLayeMid">
                ...
                {pattern[2][1] === 0 && (
                  <circle cx={79.37} cy={140.05} r={7.81} className="empty" />
                )}
                {pattern[2][1] === 1 && (
                  <path
              ...
              <g id="template_svg__secondLayerRight">
                ...
                {pattern[2][2] === 0 && (
                  <circle cx={112.85} cy={140.05} r={7.81} className="empty" />
                )}
                {pattern[2][2] === 1 && (
                  <path
              ...
              <g id="template_svg__outerLayerLeft">
                ...
                {pattern[3][0] === 0 && (
                  <circle cx={45.89} cy={173.53} r={7.81} className="empty" />
                )}
                {pattern[3][0] === 1 && (
                  <path
              ...
              <g id="template_svg__outerLayerMid">
                ...
                {pattern[3][1] === 0 && (
                  <circle cx={79.37} cy={173.53} r={7.81} className="empty" />
                )}
                {pattern[3][1] === 1 && (
                  <path
              ...
              <g id="template_svg__outerLayerRight">
                ...
                {pattern[3][2] === 0 && (
                  <circle cx={112.85} cy={173.53} r={7.81} className="empty" />
                )}
                {pattern[3][2] === 1 && (
                  <path
